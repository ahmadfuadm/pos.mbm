...
<html lang="en">
    ...
    <body>
        <div class="ticket">
            ...
            <table style="padding-top: 5px !important" class="border-bottom width-66">
                <thead class="border-bottom-dotted">
                    <tr>
                        ...
                        <th class="price text-center">{{$receipt_details->table_subtotal_label}}</th>
                    </tr>
                </thead>
                <tbody>
                	@forelse($receipt_details->lines as $line)
	                    <tr>
	                        ...
	                        <td class="quantity text-center">{{$line['quantity']}} {{$line['units']}}</td>
            ...
            <table class="border-bottom width-100">
				...
				@endif
                <tr>
                    <th class="left text-center sub-headings">
                    	{!! $receipt_details->subtotal_label !!}
                    </th>
                    <td class="width-50 text-center sub-headings">
				...
				<tr>
					<th class="width-50 text-center sub-headings">
				...
				@if(!empty($receipt_details->payments))
					@foreach($receipt_details->payments as $payment)
						<tr>
							<td class="width-50 text-center">{{$payment['method']}} ({{$payment['date']}}) </td>
							<td class="width-50 text-center">{{$payment['amount']}}</td>
						</tr>
					@endforeach
				@endif
